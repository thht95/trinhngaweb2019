...
{
    public partial class DuyetSanPham : System.Web.UI.UserControl
    {
        ...
        {
            rptSanPhamNewsDetails.DataSource = _clssanpham.GetListChiTietSanPhamChuaDuocDuyetbyIDdanhmuc(conn, int.Parse(drpSanPhamCategory.SelectedValue.ToString()));
            rptSanPhamNewsDetails.DataBind();
        }
        protected void Delete_Load(object sender, System.EventArgs e)
        {
            ((LinkButton)sender).Attributes["onclick"] = "return confirm('Bạn có chắc chắn muốn duyệt sản phẩm này ??')";
            ...
            switch (e.CommandName.ToString())
            {
                ...
                case "thaydoi":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            _clssanpham.ActiveSanPham(conn, int.Parse(e.CommandArgument.ToString()), true);
                        }
